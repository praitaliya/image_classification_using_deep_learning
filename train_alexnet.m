...
layers = importCaffeLayers('/home/prashant/deploy.prototxt');

options = trainingOptions('sgdm','MaxEpochs',100,... 
      'MiniBatchSize',300,...
      'CheckpointPath','/home/prashant/Data');

net_vgg = trainNetwork(trainingImages,layers,options);

save net_vgg net_vgg